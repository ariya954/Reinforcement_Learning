...
if __name__ == '__main__':
    ...
    for num_updates in num_updates_list:
        for _ in range(num_runs):
            V = algorithms.td0_policy_evaluation(env, random_policy, discount, learning_rate, num_updates)
    ...
    results_Q = []
    for _ in range(num_runs):
        Q = algorithms.td0_policy_evaluation_qpi(env, random_policy, discount, learning_rate, 20000)
        results_Q.append(Q)
