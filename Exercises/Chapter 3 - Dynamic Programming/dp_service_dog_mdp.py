...
if __name__ == '__main__':
    ...
    random_pi_state_values = algorithms.policy_evaluation(env, random_policy, discount)
    ...
    optimal_pi, optimal_V, optimal_Q = algorithms.policy_iteration(env, discount)
    ...
    optimal_pi, optimal_V = algorithms.value_iteration(env, discount)
    print('Optimal policy:')
    utils.print_policy(env, optimal_pi)
    print('Optimal state value function:')
    utils.print_state_value(env, optimal_V)
    ...
    for discount in [0, 0.3, 0.5, 0.7, 0.9, 1]:
        ...
        optimal_V = algorithms.policy_evaluation(env, optimal_pi, discount)
        print('Optimal state value function:')
        utils.print_state_value(env, optimal_V)
        print('\n')
